...
void BSP_LCD_DrawRectOutline(uint16_t color){
	// Top 3 lines
	BSP_LCD_DrawFastHLine(0, 0, 127, color);
	BSP_LCD_DrawFastHLine(0, 1, 127, color);
	BSP_LCD_DrawFastHLine(0, 2, 127, color);

	// Left 3 lines
	BSP_LCD_DrawFastVLine(0, 0, 127, color);
	BSP_LCD_DrawFastVLine(1, 0, 127, color);
	BSP_LCD_DrawFastVLine(2, 0, 127, color);

	// Right 3 lines
	BSP_LCD_DrawFastVLine(125, 0, 127, color);
	BSP_LCD_DrawFastVLine(126, 0, 127, color);
	BSP_LCD_DrawFastVLine(127, 0, 127, color);					

	// Bottom 3 lines
	BSP_LCD_DrawFastHLine(0, 125, 127, color);
	BSP_LCD_DrawFastHLine(0, 126, 127, color);
	BSP_LCD_DrawFastHLine(0, 127, 127, color);
}
...
void BSP_LCD_DrawHeart(int16_t x, int16_t y, int16_t bgColor){
	BSP_LCD_DrawFastVLine(x, y+1, 3, bgColor);
	BSP_LCD_DrawFastVLine(x+1, y, 5, bgColor);
	BSP_LCD_DrawFastVLine(x+2, y, 6, bgColor);
	BSP_LCD_DrawFastVLine(x+3, y+1, 6, bgColor);
	BSP_LCD_DrawFastVLine(x+4, y, 6, bgColor);
	BSP_LCD_DrawFastVLine(x+5, y, 5, bgColor);
	BSP_LCD_DrawFastVLine(x+6, y+1, 3, bgColor);
}

void BSP_LCD_DrawHourglass(int16_t x, int16_t y, int16_t bgColor){
	if (bgColor == LCD_BLACK){
		BSP_LCD_FillRect(x, y, 7, 7, bgColor);
	}
	else{
		// Top line
		BSP_LCD_DrawFastHLine(x, y, 7, bgColor);

		// second line
		BSP_LCD_DrawFastHLine(x, y+1, 1, bgColor);
		BSP_LCD_DrawFastHLine(x+1, y+1, 2, LCD_WHITE);
		BSP_LCD_DrawFastHLine(x+3, y+1, 1, LCD_ORANGE);
		BSP_LCD_DrawFastHLine(x+4, y+1, 2, LCD_WHITE);
		BSP_LCD_DrawFastHLine(x+6, y+1, 1, bgColor);

		// 3rd line
		BSP_LCD_DrawFastHLine(x+1, y+2, 1, bgColor);
		BSP_LCD_DrawFastHLine(x+2, y+2, 1, LCD_ORANGE);
		BSP_LCD_DrawFastHLine(x+3, y+2, 1, LCD_WHITE);
		BSP_LCD_DrawFastHLine(x+4, y+2, 1, LCD_ORANGE);
		BSP_LCD_DrawFastHLine(x+5, y+2, 1, bgColor);

		// 4th line
		BSP_LCD_DrawFastHLine(x+2, y+3, 1, bgColor);
		BSP_LCD_DrawFastHLine(x+3, y+3, 1, LCD_ORANGE);
		BSP_LCD_DrawFastHLine(x+4, y+3, 1, bgColor);

		// 5th line
		BSP_LCD_DrawFastHLine(x+1, y+4, 1, bgColor);
		BSP_LCD_DrawFastHLine(x+2, y+4, 1, LCD_WHITE);
		BSP_LCD_DrawFastHLine(x+3, y+4, 1, LCD_ORANGE);
		BSP_LCD_DrawFastHLine(x+4, y+4, 1, LCD_WHITE);
		BSP_LCD_DrawFastHLine(x+5, y+4, 1, bgColor);

		// 6th line
		BSP_LCD_DrawFastHLine(x, 	 y+5, 1, bgColor);
		BSP_LCD_DrawFastHLine(x+1, y+5, 2, LCD_WHITE);
		BSP_LCD_DrawFastHLine(x+2, y+5, 3, LCD_ORANGE);
		BSP_LCD_DrawFastHLine(x+5, y+5, 1, LCD_WHITE);
		BSP_LCD_DrawFastHLine(x+6, y+5, 1, bgColor);

		// 7th line
		BSP_LCD_DrawFastHLine(x, y+6, 7, bgColor);
	}
}

void BSP_LCD_DrawLightning(int16_t x, int16_t y, int16_t bgColor){
	BSP_LCD_DrawFastHLine(x+2, y, 4, bgColor);
	BSP_LCD_DrawFastHLine(x+2, y+1, 3, bgColor);
	BSP_LCD_DrawFastHLine(x+1, y+2, 3, bgColor);
	BSP_LCD_DrawFastHLine(x, y+3, 6, bgColor);
	BSP_LCD_DrawFastHLine(x+2, y+4, 3, bgColor);
	BSP_LCD_DrawFastHLine(x+1, y+5, 3, bgColor);
	BSP_LCD_DrawFastHLine(x, y+6, 2, bgColor);
}

void BSP_LCD_Draw2x(int16_t x, int16_t y, int16_t bgColor){
	BSP_LCD_DrawString(x,y, "x2", bgColor);
}

void BSP_LCD_DrawStar(int16_t x, int16_t y, int16_t bgColor){
	BSP_LCD_DrawFastHLine(x, y+3, 7, bgColor);
	BSP_LCD_DrawFastVLine(x+3, y, 7, bgColor);

	BSP_LCD_DrawFastHLine(x, y, 1, bgColor);
	BSP_LCD_DrawFastHLine(x+6, y, 1, bgColor);

	BSP_LCD_DrawFastHLine(x+1, y+1, 1, bgColor);
	BSP_LCD_DrawFastHLine(x+5, y+1, 1, bgColor);

	BSP_LCD_DrawFastHLine(x+2, y+2, 3, bgColor);
	BSP_LCD_DrawFastHLine(x+2, y+4, 3, bgColor);

	BSP_LCD_DrawFastHLine(x+1, y+5, 1, bgColor);
	BSP_LCD_DrawFastHLine(x+5, y+5, 1, bgColor);

	BSP_LCD_DrawFastHLine(x, y+6, 1, bgColor);
	BSP_LCD_DrawFastHLine(x+6, y+6, 1, bgColor);
}
